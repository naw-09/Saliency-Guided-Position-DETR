...
class PositionDETR(DNDETRDetector):
    ...
    def forward(self, images: List[Tensor], targets: List[Dict] = None):
        ...
        # Feature-level ASR is intentionally disabled in this variant.
        # Saliency refinement is performed inside the transformer encoder
        # after FGFE and before Multi-Scale Deformable Attention.
