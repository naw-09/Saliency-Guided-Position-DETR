...
def test_on_dataset():
    ...
    dataset = CocoDetection(
        ...
        ann_file=f"{args.coco_path}/annotations/instances_{args.subset}.json",
    ...
    if args.model_config is None or args.show_dir and accelerator.is_main_process:
        coco_dt = loadRes(COCO(f"{args.coco_path}/annotations/instances_{args.subset}.json"), args.result)
